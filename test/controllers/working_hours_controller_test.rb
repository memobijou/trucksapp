...
class WorkingHoursControllerTest < ActionController::TestCase
  ...
  test "should create working_hour" do
    assert_difference('WorkingHour.count') do
      post :create, working_hour: { day_id: @working_hour.day_id, end_zeit: @working_hour.end_zeit, start_time: @working_hour.start_time }
    end
  ...
  test "should update working_hour" do
    patch :update, id: @working_hour, working_hour: { day_id: @working_hour.day_id, end_zeit: @working_hour.end_zeit, start_time: @working_hour.start_time }
    assert_redirected_to working_hour_path(assigns(:working_hour))
  end
